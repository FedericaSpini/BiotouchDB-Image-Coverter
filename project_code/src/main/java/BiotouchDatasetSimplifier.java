...
public class BiotouchDatasetSimplifier {
    private File dbFolderPath;
    private File newDbFolderPath;


    public BiotouchDatasetSimplifier(String dbFolderPath, String newDbFolderPath){
     ...
     * */
    private void makeNewDBDir(File sourceFolder, File destinationFolder) throws IOException
    {
