...
public class BiotouchDatasetImageConverter {
    ...
    private void makeImgDataset(File sourceFolder, File destinationFolder) throws IOException
    {
        ...
        {
            if (Anonymizer.getFileExtension(sourceFolder).equals("json")) {
                ...
                imageCreator.createImageFromJson(o, Anonymizer.changeFilePathExtension(destinationFolder.getPath(),"png"));
            }
        }
    }
...
//        idsManager.updateUserIdentificationFile();
        ...
        Anonymizer.copyFolderAnonimized(dbConverter.getDbFolderPath(),dbConverter.getNewDbFolderPath(), "");
